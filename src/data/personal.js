export const personalInfo = {
  name: "Shahul Hameed Badhusha Ansari",
  title: "Java Backend Developer | Spring Boot | Microservices | REST API Specialist",
  subtitle: "Building Scalable Applications with 4+ Years of Experience",
  ...
  quickFacts: [
    ...
    "AWS Cloud Integration & S3 Storage",
    "Real-time Data Processing with Kafka",
    "Database Optimization & Performance",
    "Agile Development & Team Collaboration",
    "Multi-role E-commerce Solutions"
  ],
